  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-3xl mx-auto px-6 pt-24">
        <h1 className="font-display text-5xl md:text-7xl lg:text-8xl font-light text-charcoal leading-[1.1] mb-8">
          Some rooms are
          <br />
          <em className="font-light">never forgotten.</em>
        </h1>
        <div className="w-16 h-px bg-bronze mx-auto mb-8" />
        <p className="font-body text-sm md:text-base leading-relaxed text-taupe max-w-xl mx-auto mb-12 font-light">
        ...
        <a
          href="#contact"
          className="inline-block font-body text-xs tracking-[0.25em] uppercase text-charcoal border-b border-charcoal pb-1 hover:text-bronze hover:border-bronze transition-colors"
        >
          Begin Your Journey
        </a>
      </div>
