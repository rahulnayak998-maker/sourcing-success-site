      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div className="order-2 lg:order-1">
            <p className="font-body text-xl tracking-[0.3em] uppercase text-taupe mb-6">About Tandee</p>
            <h2 className="font-display text-4xl md:text-5xl font-light text-charcoal leading-tight mb-8">
              <em>We built Tandee for one kind of client.</em>
            </h2>

            <div className="space-y-5 font-body text-lg text-taupe leading-[1.8] font-light">
              <p>
              ...
              <p className="font-display text-xl text-charcoal italic font-light !leading-relaxed">
        ...
        <div className="mt-24 border-t border-divider pt-16 max-w-4xl mx-auto text-center">
          <p className="font-body text-xl tracking-[0.3em] uppercase text-taupe mb-6">Leadership</p>
          <h3 className="font-display text-3xl md:text-4xl font-light text-charcoal mb-6">
            <em>Led by 25 years of design knowledge</em>
          </h3>
          <p className="font-body text-lg text-taupe leading-[1.8] font-light">
